...
📄 [Paper](https://arxiv.org/abs/2605.18663) | 🤗 [Dataset](https://huggingface.co/datasets/facebook/gim)
</div>
...
We release the evaluation framework, calibrated IRT parameters, and all public problems.
